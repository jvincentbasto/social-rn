...
// ✅ Set app identifier in one place
const APP_IDENTIFIER = "socialrn/1.0.0 (ReactNative)";
...
export const createApiClient = (getToken: () => Promise<string | null>): AxiosInstance => {
  ...
  api.interceptors.request.use(async (config) => {
    ...
    // ✅ Add custom headers for Arcjet bot detection
    config.headers["User-Agent"] = APP_IDENTIFIER;
    config.headers["X-App-Client"] = "socialrn";
